	...
	public function new(curStage)
	{
		...
		switch (curStage)
		{
			...
			case 'nether':
				...
				var bg:FlxSprite = new FlxSprite(-160, -160).loadGraphic(Paths.image('backgrounds/' + curStage + '/bg'));
				bg.antialiasing = true;
				bg.scrollFactor.set(0.6, 0.6);
				add(bg);

				var fg:FlxSprite = new FlxSprite(-160, -160).loadGraphic(Paths.image('backgrounds/' + curStage + '/fg'));
